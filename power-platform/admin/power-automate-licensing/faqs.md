...
> [!NOTE]
> Enforcements are deployed a geo region at a time, dates above are for earliest region. If you don't see notifications in Power Platform Admin center or Power Automate portal even though the date listed in the table passed, it means the enforcement is not deployed in your region yet.
...
Makers can also associate their flows to apps from Power Automate portal, to learn more go to [Associate flows to apps](/power-automate/associate-flow-to-app).
